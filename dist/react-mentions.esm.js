...
import useStyle$1, { createUseStyle as createUseStyle$1, inline } from 'substyle';
...
function createDefaultStyle(defaultStyle, getModifiers, getDependsOn) {
  var enhance = function enhance(ComponentToWrap) {
    var useStyle = createUseStyle$1(defaultStyle, getModifiers, getDependsOn);

    var DefaultStyleEnhancer = function DefaultStyleEnhancer(props) {
      var style = useStyle(props);
      return /*#__PURE__*/React.createElement(ComponentToWrap, _extends({}, props, {
        style: style
      }));
    };
...
var Suggestion = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Suggestion, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("li", _extends({}, rest, this.props.style), this.renderContent());
    }
  }, {
    key: "renderContent",
...
function LoadingIndicator() {
  var style = useStyle$1({});
  var spinnerStyle = style('spinner');
  return /*#__PURE__*/React.createElement("div", style, /*#__PURE__*/React.createElement("div", spinnerStyle, /*#__PURE__*/React.createElement("div", spinnerStyle(['element', 'element1'])), /*#__PURE__*/React.createElement("div", spinnerStyle(['element', 'element2'])), /*#__PURE__*/React.createElement("div", spinnerStyle(['element', 'element3'])), /*#__PURE__*/React.createElement("div", spinnerStyle(['element', 'element4'])), /*#__PURE__*/React.createElement("div", spinnerStyle(['element', 'element5']))));
}
...
var SuggestionsOverlay = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SuggestionsOverlay, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React.createElement("div", _extends({}, inline(style, {
        position: position,
        left: left,
        top: top
      }), {
...
var Mention = function Mention(props) {
  ...
  return /*#__PURE__*/React.createElement("strong", style, display);
};
