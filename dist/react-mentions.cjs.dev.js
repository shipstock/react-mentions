...
var useStyle$1 = require('substyle');
var useStyle$1__default = _interopDefault(useStyle$1);
...
function createDefaultStyle(defaultStyle, getModifiers, getDependsOn) {
  var enhance = function enhance(ComponentToWrap) {
    var useStyle = useStyle$1.createUseStyle(defaultStyle, getModifiers, getDependsOn);

    var DefaultStyleEnhancer = function DefaultStyleEnhancer(props) {
      var style = useStyle(props);
      return /*#__PURE__*/React__default.createElement(ComponentToWrap, _extends({}, props, {
        style: style
      }));
    };
...
var Suggestion = /*#__PURE__*/function (_Component) {
  ...
  _createClass(Suggestion, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("li", _extends({}, rest, this.props.style), this.renderContent());
    }
  }, {
    key: "renderContent",
...
function LoadingIndicator() {
  var style = useStyle$1__default({});
  var spinnerStyle = style('spinner');
  return /*#__PURE__*/React__default.createElement("div", style, /*#__PURE__*/React__default.createElement("div", spinnerStyle, /*#__PURE__*/React__default.createElement("div", spinnerStyle(['element', 'element1'])), /*#__PURE__*/React__default.createElement("div", spinnerStyle(['element', 'element2'])), /*#__PURE__*/React__default.createElement("div", spinnerStyle(['element', 'element3'])), /*#__PURE__*/React__default.createElement("div", spinnerStyle(['element', 'element4'])), /*#__PURE__*/React__default.createElement("div", spinnerStyle(['element', 'element5']))));
}
...
var SuggestionsOverlay = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SuggestionsOverlay, [{
    ...
    value: function render() {
      ...
      return /*#__PURE__*/React__default.createElement("div", _extends({}, useStyle$1.inline(style, {
        position: position,
        left: left,
        top: top
      }), {
...
var useStyle = useStyle$1.createUseStyle({
  fontWeight: 'inherit'
});
...
var Mention = function Mention(props) {
  ...
  return /*#__PURE__*/React__default.createElement("strong", style, display);
};
